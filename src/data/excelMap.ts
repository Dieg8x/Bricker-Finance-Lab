...
export const excelMap: TopicDefinition[] = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { key: "futurePosition", label: "Posición en el futuro", defaultValue: "long", type: "select", options: [
        { label: "Larga — compra (esperas que SUBA)", value: "long" },
        { label: "Corta — venta (esperas que BAJE o cubres posición larga)", value: "short" },
      ], helper: "Determina la dirección del perfil de pagos." },
      { key: "payoffStep", label: "Paso del perfil de pagos", defaultValue: 2, helper: "Intervalo entre precios en la tabla (ej. 2 para: SP-10, SP-8, ... SP, ... SP+10)." },
    ],

...
export const excelMap: TopicDefinition[] = [
  ...
  },
  {
    ...
    category: "Futuros",
    inputs: [
      { key: "portfolioValue", label: "Valor del portafolio", unit: "$", defaultValue: 1500000 },
      { key: "futurePrice", label: "Precio futuro", defaultValue: 5200 },
      { key: "multiplier", label: "Multiplicador del contrato", defaultValue: 10 },
      { key: "beta", label: "Beta del portafolio", defaultValue: 1.2 },
    ],
    outputs: [{ key: "contracts", label: "Contratos óptimos", formula: "Beta × (Valor / (F × M))" }],
  },
  {

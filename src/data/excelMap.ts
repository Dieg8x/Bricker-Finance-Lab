...
export const excelMap: TopicDefinition[] = [
  ...
  },
  {
    ...
    description: "Precio futuro de una acción descontando el valor presente del dividendo.",
    difficulty: "Medio",
    category: "Futuros",
    useCase: "Usalo cuando: el problema da spot, tasa libre de riesgo, plazo y dividendo para calcular el precio futuro justo.",
    formulaDisplay: "F = (S - VP_dividendo) × (1 + r × d/360)  |  VP_dividendo = D / (1 + r × d_div/360)",
    inputs: [
